...
knowledge0 = And(
    Not(And(AKnight, AKnave)),  # he cannot be a knight and knave at the same time
    Or(AKnight, AKnave),         
...
knowledge1 = And(
    Not(And(AKnight, AKnave)),  # he cannot be a knight and knave at the same time
    Or(AKnight, AKnave),        # will he be a knight or a Knave

    Not(And(BKnight, BKnave)),  # he cannot be a knight and knave at the same time
    Or(BKnight, BKnave),        # will he be a knight or a Knave
